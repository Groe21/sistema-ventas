...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 mb-0"><i class="bi bi-gear me-2"></i>Configuración del Sistema</h1>
</div>
...
<div class="card shadow-sm">
    <div class="card-body text-center py-5">
        ...
        <p class="text-muted">La configuración global del sistema estará disponible próximamente.</p>
