...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 mb-0"><i class="bi bi-credit-card me-2"></i>Suscripciones</h1>
</div>
...
<div class="card shadow-sm">
    <div class="card-body text-center py-5">
        ...
        <p class="text-muted">La gestión de suscripciones y planes estará disponible próximamente.</p>
